...
oc import-image my-amq-broker-7/amq-broker-72-openshift:1.2 --from=registry.access.redhat.com/amq-broker-7/amq-broker-72-openshift:1.2 --confirm
...
oc new-app -f amq-broker-72-persistence-clustered-ssl.yaml \
    ...
    -p IMAGE=registry.access.redhat.com/amq-broker-7/amq-broker-72-openshift:1.2
